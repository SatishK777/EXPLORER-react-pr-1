...
import './App.css'
import Data from './Components/ID/Id'
      ...
      <div className='d-flex'>
        {
          result.map((element,index) => (
            ...
            <div key={index}>
              {/* <div>
                <Data element={element}  key = {key++}/>
              </div>

              <div>

                <Username  element={element}  key = {key++}/>
              </div>

              <div>
                <Mail  element={element}  key = {key++}/>
              </div>

              <div>
                <FullName  element={element}  key = {key++}/>
              </div>

              <div>
                <DateOfBirth  element={element}  key = {key++}/>
              </div>

              <div>
                <Contact  element={element}  key = {key++}/>
              </div>

              <div>
                <Address  element={element}  key = {key++}/>
              </div>

              <div>
                <Image  element={element}  key = {key++}/>
              </div> */}
